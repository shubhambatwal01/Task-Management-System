    ...
    <div className="mt-8 rounded-3xl border border-slate-200 bg-slate-50 p-5 shadow-sm shadow-slate-200/60 sm:p-6">
      <div className="grid gap-4 sm:grid-cols-[1.7fr_1fr_auto]">
        ...
        <button
          ...
          className="rounded-2xl bg-linear-to-r from-indigo-600 to-sky-500 px-6 py-3 text-sm font-semibold text-white transition hover:opacity-95 focus:outline-none focus:ring-2 focus:ring-indigo-400"
        >
          Add task
        </button>
      </div>
